      ...
      <div class="p-8">
        ...
        <div class="mb-6">
          <form method="GET" class="relative">
            ...
            <input type="search" name="search" placeholder="Search by name or phone..." value="<?php echo htmlspecialchars($search); ?>" class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 transition">
          </form>
        </div>
