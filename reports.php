          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            <div>
              <label class="block mb-2 text-sm font-bold text-gray-700 uppercase tracking-wide">
                <i class="fas fa-calendar text-blue-600 mr-2"></i>From Date
              </label>
            ...
            <div>
              <label class="block mb-2 text-sm font-bold text-gray-700 uppercase tracking-wide">
                <i class="fas fa-calendar text-blue-600 mr-2"></i>To Date
              </label>
            ...
            <div class="flex gap-2 col-span-1 md:col-span-3">
              <button type="submit" class="flex-1 px-4 py-2 font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition flex items-center justify-center gap-2">
                <i class="fas fa-search"></i>Filter
              </button>
              <a href="reports.php" class="flex-1 px-4 py-2 font-bold text-gray-700 border-2 border-gray-300 hover:bg-gray-100 rounded-lg text-center transition flex items-center justify-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
            <div class="p-6">
              ...
              <p class="text-xs text-gray-600 mt-2">
                <i class="fas fa-check-circle text-green-600 mr-1"></i>Completed
              </p>
            </div>
          </div>
          ...
          <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
            <div class="p-6">
              ...
              <p class="text-xs text-gray-600 mt-2">
                <i class="fas fa-chart-line text-green-600 mr-1"></i>Revenue
              </p>
            </div>
          </div>
          ...
          <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
            <div class="p-6">
              ...
              <p class="text-xs text-gray-600 mt-2">
                <i class="fas fa-info-circle text-orange-600 mr-1"></i>Per transaction
              </p>
            </div>
          </div>
        </div>
