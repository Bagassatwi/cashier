<?php
// Sidebar Component
// Usage: include 'sidebar.php'; (Make sure $page variable is set before including)
// Example: $page = 'dashboard'; include 'sidebar.php';
?>
<aside class="w-64 bg-gray-900 text-white shadow-lg">
  ...
  <div class="absolute bottom-0 left-0 right-0 w-64 p-3 border-t border-gray-700">
    <a href="logout.php" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition text-red-400">
